...
public class PermissionMgr {
    private static final com.example.sharedweibo.PermissionMgr sInstance = new com.example.sharedweibo.PermissionMgr();
    ...
    public static com.example.sharedweibo.PermissionMgr getInstance() {
        return sInstance;
    }
